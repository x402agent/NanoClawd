...
```yaml
- uses: qwibitai/nanoclawd/repo-tokens@v1
  with:
    include: 'src/**/*.ts'
    exclude: 'src/**/*.test.ts'
```
...
| Repo | Badge |
|------|-------|
| [NanoClawd](https://github.com/qwibitai/NanoClawd) | ![tokens](https://raw.githubusercontent.com/qwibitai/NanoClawd/main/repo-tokens/badge.svg) |
