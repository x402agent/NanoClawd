...
// CLI command barrel — populates the `nclwd` registry before the CLI server
// accepts connections.
...
async function main(): Promise<void> {
  ...
  // 7. Start the `nclwd` CLI socket server (data/nclwd.sock).
  await startCliServer();

  log.info('NanoClawd running');
}
