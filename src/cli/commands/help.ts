 ...
 *
 *   nclwd help               — list all resources and commands
 *   nclwd groups help         — show group resource details (verbs, columns, enums)
 */
...
register({
  ...
  handler: async (_args, ctx) => {
    ...
    lines.push('');
    lines.push('Run `nclwd <resource> help` for detailed field information.');
    return lines.join('\n');
  },
});
