...
NanoClawd doesn't ship channels in trunk. This skill copies the Slack adapter in from the `channels` branch.
...
2. Name it (e.g., "NanoClawd") and select your workspace
