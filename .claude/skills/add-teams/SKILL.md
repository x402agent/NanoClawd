...
2. Click **New client secret**, description "nanoclawd", expiry 180 days
...
- **how-to-find-id**: Send a message to the bot in the channel. NanoClawd auto-creates a messaging group and logs the platform ID. Use that messaging group ID for wiring.
